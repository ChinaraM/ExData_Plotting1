...
par(mfrow=c(2,2))
with(subsetdata, plot(Fulltime, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
with(subsetdata, plot(Fulltime, Voltage, type = "l", xlab="datetime", ylab="Voltage"))
...
with(subsetdata, plot(Fulltime, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
dev.off()
